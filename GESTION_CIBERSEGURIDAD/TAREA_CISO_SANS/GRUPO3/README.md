...
1.	**Cloud Security Architecture**: Diseñar arquitecturas seguras en entornos cloud.
2.	**Cloud Guidelines**: Definir lineamientos de seguridad para el uso de la nube.
### **Mobile (Móviles)**
...
![](https://github.com/jaiderospina/ANTICIPACION_2025_AULA_Q/blob/main/GESTION_CIBERSEGURIDAD/TAREA_CISO_SANS/GRUPO3/Imagenes/inteligencia.png)
